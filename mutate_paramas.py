...
np.save('mutated_params/layer1weights1', layer1weights1)
np.save('mutated_params/layer1weights2', layer1weights2)
np.save('mutated_params/layer1biases1', layer1biases1)
np.save('mutated_params/layer1biases2', layer1biases2)

np.save('mutated_params/layer2weights1', layer2weights1)
np.save('mutated_params/layer2biases1', layer2biases1)

np.save('mutated_params/layer3weights1', layer3weights1)
np.save('mutated_params/layer3weights2', layer3weights2)
np.save('mutated_params/layer3weights3', layer3weights3)
np.save('mutated_params/layer3biases1', layer3biases1)
np.save('mutated_params/layer3biases2', layer3biases2)
np.save('mutated_params/layer3biases3', layer3biases3)

np.save('mutated_params/layer4weights1', layer4weights1)
np.save('mutated_params/layer4weights2', layer4weights2)
np.save('mutated_params/layer4biases1', layer4biases1)
np.save('mutated_params/layer4biases2', layer4biases2)